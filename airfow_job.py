...
with DAG(
    ...
    gcs_bucket = "credit-card-data-analysis_24"
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "422065537407-compute@developer.gserviceaccount.com",
                "network_uri": "projects/bigqueryprojects24/global/networks/default",
                "subnetwork_uri": "projects/bigqueryprojects24/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="bigqueryprojects24",
        region="us-central1",
        gcp_conn_id="google_cloud_default",
    )

    # Task 3: Move processed files to archive
